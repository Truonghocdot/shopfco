...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-12 text-center relative">
        ...
        <h1 class="text-3xl font-black uppercase tracking-tight text-white mb-3 flex justify-center items-center gap-4 relative z-10">
            <span class="material-icons text-4xl text-primary drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]">category</span>
            {{ $category->title }}
        </h1>
        @if($category->description)
        <p class="text-slate-400 max-w-2xl mx-auto font-bold">{{ $category->description }}</p>
        @endif
    ...
    <div class="glass rounded-2xl border border-white/10 p-12 text-center">
        <span class="material-icons text-6xl text-slate-700 mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.05)]">inventory_2</span>
        <p class="text-2xl font-black mb-3 text-white uppercase tracking-tighter">Chưa có sản phẩm</p>
        <p class="text-slate-500 font-bold">Danh mục này hiện chưa có sản phẩm nào</p>
    </div>
    @endif
</div>
