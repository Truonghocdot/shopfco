...
<div class="policy-page relative overflow-hidden bg-black min-h-screen pt-12 pb-20">
    ...
    <div class="container mx-auto px-4 relative z-10 max-w-6xl">
        ...
        <div class="space-y-12">
            ...
            <!-- Community Section -->
            <div class="techno-section border-l-4 border-primary bg-primary/5 p-8 relative overflow-hidden mt-16">
            ...
            <!-- Closing Note -->
            <div class="text-center max-w-3xl mx-auto border border-primary/20 bg-black/40 backdrop-blur-md p-10 rounded-2xl relative overflow-hidden mt-16">
